...
clsRecharge22Commit = class("clsRecharge22Commit", clsBaseUI)

function clsRecharge22Commit:ctor(parent)
	clsBaseUI.ctor(self, parent, "uistu/Recharge22Commit.csb")
...
function clsRecharge22Commit:dtor()
	
end

function clsRecharge22Commit:BindTypeBtn(btn, name, bank_style, Type, id)
...
function clsRecharge22Commit:CheckBankStyle(btn)
...
--注册控件事件
function clsRecharge22Commit:InitUiEvents()
...
function clsRecharge22Commit:AskPay(bank_style, money, info1, info2)
...
-- 注册全局事件
function clsRecharge22Commit:InitGlbEvents()
	g_EventMgr:AddListener(self,"RechargeOver",function()
        self:removeSelf()
    end,self)
end

function clsRecharge22Commit:SetParams(money, info1, info2)
	self.info1 = info1
	self.info2 = info2
